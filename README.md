...
> ESP32-S3 AMOLED frontend, Python service on the Pi, Claude Agent SDK + [`robot-md-mcp`](https://github.com/RobotRegistryFoundation/robot-md-mcp) on the backend.
...
A $35 Waveshare ESP32-S3 Touch AMOLED 1.8" becomes a portable remote for any `ROBOT.md`-declared robot. Three ways to drive the robot from the pendant:
...
- **Pendant:** Waveshare ESP32-S3 Touch AMOLED 1.8" (onboard mic + speaker).
